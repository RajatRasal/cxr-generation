...
class ExpandChannels:
    """Transforms an image with one channel to an image with three channels by
    copying pixel intensities of the image along the 1st dimension."""
...
def infer_resize_params(
    ...
    """Given the validation transforms pipeline, extract the sizes to which the
    image was resized and cropped, if any."""
