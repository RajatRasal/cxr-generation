...
from .text import BERT_MODEL_DIM, bert_embed, tokenize
...
class Unet3D(nn.Module):
    ...
    def forward(
        ...
        """
        prob_focus_present: Probability at which a given batch sample will focus on
        the present (0. is all off, 1. is completely arrested attention across time)
        """
        assert not (
